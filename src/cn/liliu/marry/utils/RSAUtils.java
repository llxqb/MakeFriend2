...
/**
 * Created by li.liu on 2018/6/11.
 *
 */
...
public class RSAUtils {
    ...
    private static byte[] processData(Cipher cipher, int opmode, byte[] datas, int keySize) {
        int maxBlock = 0;
    ...
    public static String encryptDataByPublicKey(byte[] srcData, PublicKey publicKey){
        ...
        return Base64.getEncoder().encodeToString(Base64.getEncoder().encode(resultBytes));
    ...
    public static byte[] decryptDataByPrivate(String encryptedData, PrivateKey privateKey){
        ...
        byte[] bytes = Base64.getDecoder().decode( Base64.getDecoder().decode(encryptedData));
